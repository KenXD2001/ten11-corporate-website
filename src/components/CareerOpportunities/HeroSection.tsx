    ...
    <section className="relative w-full h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative text-center px-6 z-10">
        ...
        <p className="text-lg md:text-2xl text-white/80">
          At Ten11 Hospitality, we are always looking for passionate and driven individuals to join our team. Explore our current openings and become a part of our journey to redefine hospitality.
        </p>
      </div>
    </section>
  );
